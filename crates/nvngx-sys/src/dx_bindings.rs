...
pub struct NVSDK_NGX_D3D12_GBuffer {
    pub pInAttrib: [*mut ID3D12Resource; 17usize],
}
#[test]
...
pub struct NVSDK_NGX_D3D12_DLSSD_Eval_Params {
    ...
    pub pInResponsivityMask: *mut ID3D12Resource,
...
fn bindgen_test_layout_NVSDK_NGX_D3D12_DLSSD_Eval_Params() {
    ...
    assert_eq!(
        ...
        888usize,
        "Offset of field: NVSDK_NGX_D3D12_DLSSD_Eval_Params::pInResponsivityMask"
    );
    assert_eq!(
        unsafe {
        ...
        896usize,
        "Offset of field: NVSDK_NGX_D3D12_DLSSD_Eval_Params::InResponsivityMaskSubrectBase"
    );
}

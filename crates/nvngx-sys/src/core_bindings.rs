...
pub const NVSDK_NGX_DLSS_DEBUG_OVERLAY_VALUE_UNSET: i32 = -1;
...
pub const NVSDK_NGX_Parameter_DLSS_Overlay_Debug_Layer: &[u8; 25] = b"DLSS.Overlay.Debug.Layer\0";
pub const NVSDK_NGX_Parameter_DLSS_Overlay_Full_Screen: &[u8; 25] = b"DLSS.Overlay.Full.Screen\0";
pub const NVSDK_NGX_Parameter_DLSS_Overlay_Show_Nans: &[u8; 23] = b"DLSS.Overlay.Show.Nans\0";
pub const NVSDK_NGX_Parameter_DLSS_Overlay_Jitter_Debug: &[u8; 26] = b"DLSS.Overlay.Jitter.Debug\0";
...
pub const NVSDK_NGX_Parameter_DLSS_ResponsivityMask: &[u8; 22] = b"DLSS.ResponsivityMask\0";
pub const NVSDK_NGX_Parameter_DLSS_ResponsivityMask_Subrect_Base_X: &[u8; 37] =
    b"DLSS.ResponsivityMask.Subrect.Base.X\0";
pub const NVSDK_NGX_Parameter_DLSS_ResponsivityMask_Subrect_Base_Y: &[u8; 37] =
    b"DLSS.ResponsivityMask.Subrect.Base.Y\0";
...
pub const NVSDK_NGX_Parameter_DLSSD_ResponsivityMask: &[u8; 23] = b"DLSSD.ResponsivityMask\0";
...
pub const NVSDK_NGX_Parameter_DLSSD_ResponsivityMask_Subrect_Base_X: &[u8; 38] =
    b"DLSSD.ResponsivityMask.Subrect.Base.X\0";
pub const NVSDK_NGX_Parameter_DLSSD_ResponsivityMask_Subrect_Base_Y: &[u8; 38] =
    b"DLSSD.ResponsivityMask.Subrect.Base.Y\0";
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct NVSDK_NGX_CUDADevice {
    pub cudaContext: *mut ::std::os::raw::c_void,
    pub cudaStream: *mut ::std::os::raw::c_void,
}
#[test]
fn bindgen_test_layout_NVSDK_NGX_CUDADevice() {
    const UNINIT: ::std::mem::MaybeUninit<NVSDK_NGX_CUDADevice> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<NVSDK_NGX_CUDADevice>(),
        16usize,
        "Size of NVSDK_NGX_CUDADevice"
    );
    assert_eq!(
        ::std::mem::align_of::<NVSDK_NGX_CUDADevice>(),
        8usize,
        "Alignment of NVSDK_NGX_CUDADevice"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cudaContext) as usize - ptr as usize },
        0usize,
        "Offset of field: NVSDK_NGX_CUDADevice::cudaContext"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cudaStream) as usize - ptr as usize },
        8usize,
        "Offset of field: NVSDK_NGX_CUDADevice::cudaStream"
    );
}
impl Default for NVSDK_NGX_CUDADevice {
    fn default() -> Self {
...
impl NVSDK_NGX_DLSS_Feature_Flags {
    ...
    pub const NVSDK_NGX_DLSS_Feature_Flags_Reserved_8: NVSDK_NGX_DLSS_Feature_Flags =
        NVSDK_NGX_DLSS_Feature_Flags(256);
}
...
pub enum NVSDK_NGX_GBufferType {
    ...
    NVSDK_NGX_GBUFFER_RESPONSIVITY_MASK = 13,

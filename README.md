...
The DLSS version used by this crate: [`310.7.0`](https://github.com/NVIDIA/DLSS/releases/tag/v310.7.0).
...
- DX12 (via [`windows`](https://crates.io/crates/windows) bindings, Windows only).
